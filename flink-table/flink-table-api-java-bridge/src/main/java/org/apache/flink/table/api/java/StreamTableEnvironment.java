...
public interface StreamTableEnvironment extends TableEnvironment {
	...
	/**
	 * Registers the given {@link DataStream} as view in the {@link TableEnvironment}'s catalog.
	...
	/**
	 * Registers the given {@link DataStream} as a view with specified field names in the
	 * {@link TableEnvironment}'s catalog. Registered views can be referenced in SQL queries.
	 *
	 * <p>Example:
	 *
	 * <pre>
