...
public interface CrudExternalCatalog extends ExternalCatalog {
	 ...
	 */
	void dropTable(String tableName, boolean ignoreIfNotExists) throws TableNotExistException;
	 ...
	 * if set to true, nothing happens.
	 * @throws CatalogAlreadyExistsException thrown if the sub catalog does already exist in the catalog
	 * and ignoreIfExists is false
	 */
	void createSubCatalog(
		String name,
		ExternalCatalog catalog,
		boolean ignoreIfExists) throws CatalogAlreadyExistsException;
	 ...
	 */
	void dropSubCatalog(String name, boolean ignoreIfNotExists) throws CatalogNotExistException;
