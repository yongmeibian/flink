...
/**
 * Replaces '*' with all available {@link org.apache.flink.table.expressions.FieldReferenceExpression}s from underlying
 * inputs.
 */
@Internal
final class StarReferenceFlatteningRule implements ResolverRule {
	...
	private static class FieldFlatteningVisitor extends ApiExpressionDefaultVisitor<List<Expression>> {
		...
		@Override
		public List<Expression> visitUnresolvedReference(UnresolvedReferenceExpression fieldReference) {
