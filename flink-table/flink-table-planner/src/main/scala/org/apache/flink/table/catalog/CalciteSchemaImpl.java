...
/**
 * Equivalent to {@link CalciteSchemaImpl} with public access.
 */
public final class CalciteSchemaImpl extends CalciteSchema {
	/** Creates a SimpleCalciteSchema.
	 *
	 * <p>Use {@link CalciteSchema#createRootSchema(boolean)}
	 * or {@link #add(String, Schema)}. */
	public CalciteSchemaImpl(CalciteSchema parent, Schema schema, String name) {
		this(parent, schema, name, null, null, null, null, null, null, null, null);
	}

	private CalciteSchemaImpl(
	...
	public CalciteSchema add(String name, Schema schema) {
		final CalciteSchema calciteSchema = new CalciteSchemaImpl(this, schema, name);
	...
	protected CalciteSchema getImplicitSubSchema(String schemaName,
		...
		if (s != null) {
			return new CalciteSchemaImpl(this, s, schemaName);
		}
		return null;
	}
	...
	/* Functions we do not need to support */
	...
	protected void addImplicitSubSchemaToBuilder(
		...
		for (String schemaName : schema.getSubSchemaNames()) {
			...
			Schema s = schema.getSubSchema(schemaName);
			if (s != null) {
				CalciteSchema calciteSchema = new CalciteSchemaImpl(this, s, schemaName);
