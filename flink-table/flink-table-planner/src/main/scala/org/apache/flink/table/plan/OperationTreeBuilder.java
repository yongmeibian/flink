...
public class OperationTreeBuilder {
	...
	public Join join(
		...
		ExpressionResolver resolver = ExpressionResolver.resolverFor(left, right);
	...
	public Project project(
		...
		LogicalNode child) {
		return projectInternal(projectList, child, false);
	}

	public Project projectWithExplicitAlias(
		Iterable<Expression> projectList,
		LogicalNode child) {
		return projectInternal(projectList, child, true);
	}
	...
	private Project projectInternal(
		...
		ExpressionResolver resolver = ExpressionResolver.resolverFor(child);
