		...
		public Table getTable(String tableName) {
			...
			try {
				...
				if (table instanceof TableOperationCatalogView) {
					return new TableOperationTable(((TableOperationCatalogView) table).getTableOperation());
				} else {
					throw new UnsupportedOperationException("Only table operation based catalog views are supported.");
				}
