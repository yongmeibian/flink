...
trait ImplicitExpressionOperations extends BaseExpressions[Expression, Expression] {
  ...
  /**
    * Greater than.
    */
  def > (other: Expression): Expression = isGreaterThan(other)

  /**
    * Greater than or equal.
    */
  def >= (other: Expression): Expression = isGreaterThanOrEqualTo(other)

  /**
    * Less than.
    */
  def < (other: Expression): Expression = isLessThan(other)

  /**
    * Less than or equal.
    */
  def <= (other: Expression): Expression = isLessThanOrEqualTo(other)

  /**
    * Equals.
    */
  def === (other: Expression): Expression = isEqualTo(other)

  /**
    * Not equal.
    */
  def !== (other: Expression): Expression = isNotEqualTo(other)
