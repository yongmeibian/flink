...
public final class WindowAggregateOperation extends UnaryOperation {

	private final List<Expression> groupingExpressions;
	private final List<Expression> propertyExpressions;
	private final List<Expression> aggregateExpressions;
	private final TableSchema tableSchema;

	public WindowAggregateOperation(
	...
	public List<Expression> getPropertyExpressions() {
	...
	public <R> R accept(OperationTreeVisitor<R> visitor) {
		return visitor.visitWindowAggregateOperation(this);
	}
}
