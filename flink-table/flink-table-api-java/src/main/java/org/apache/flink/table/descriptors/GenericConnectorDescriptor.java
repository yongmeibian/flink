 ...
 */
@Internal
public class GenericConnectorDescriptor extends ConnectorDescriptor {

	private final DescriptorProperties properties;

	public static GenericConnectorDescriptor genericConnector(String type) {
		return new GenericConnectorDescriptor(type, 1, false);
	}

	/**
	 * Constructs a {@link GenericConnectorDescriptor}.
	 *
	 ...
	 */
	private GenericConnectorDescriptor(String type, int version, boolean formatNeeded) {
	 ...
	 */
	public GenericConnectorDescriptor property(String key, String value) {
	 ...
	 */
	public GenericConnectorDescriptor properties(Map<String, String> properties) {
