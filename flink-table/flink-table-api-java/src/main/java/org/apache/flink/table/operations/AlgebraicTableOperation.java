...
/**
 * An algebraic operation on two relations. It provides a way to union, intersect or subtract underlying
...
public class AlgebraicTableOperation implements TableOperation {
	...
	private final AlgebraicTableOperationType type;
	private final boolean all;

	public AlgebraicTableOperation(
	...
	/**
	 * Represent kind of this algebraic operation.
	 * <ul>
	...
	public AlgebraicTableOperationType getType() {
		return type;
	}
