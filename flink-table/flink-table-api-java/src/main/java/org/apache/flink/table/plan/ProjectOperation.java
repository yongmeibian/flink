...
public final class ProjectOperation extends UnaryOperation {

	private final List<Expression> projectList;
	private final boolean explicitAlias;
	...
	public boolean isExplicitAlias() {
	...
	public <R> R accept(OperationTreeVisitor<R> visitor) {
		return visitor.visitProjectOperation(this);
	}
}
