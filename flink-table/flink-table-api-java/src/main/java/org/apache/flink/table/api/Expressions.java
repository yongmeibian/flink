...
public final class Expressions {
	...
	public static ApiExpression and(Object predicate0, Object predicate1/*, Object... predicates*/) {
		return apiCall(
			...
			objectToExpression(predicate0),
			objectToExpression(predicate1));
	}
	...
	public static ApiExpression or(Object predicate0, Object predicate1/*, Object... predicates*/) {
		return apiCall(BuiltInFunctionDefinitions.OR, objectToExpression(predicate0), objectToExpression(predicate1));
	}
	...
	public static ApiExpression rowInterval(Long rows) {
		return new ApiExpression(ApiExpressionUtils.toRowInterval(valueLiteral(rows)));
	}
	...
	public static ApiExpression interval(String interval, DataTypes.Resolution lowerResolution, DataTypes.Resolution upperResolution) {
		throw new UnsupportedOperationException("Not implemented yet.");
//		return new ApiExpression(valueLiteral(interval, DataTypes.INTERVAL(lowerResolution, upperResolution)));
	}
...
//		return ApiExpressionUtils.apiCall(
...
//				aggregateFunction,
//				UserDefinedFunctionHelper.getReturnTypeOfAggregateFunction(aggregateFunction, null),
//				UserDefinedFunctionHelper.getAccumulatorTypeOfAggregateFunction(aggregateFunction, null)),
//			params);
//	}
