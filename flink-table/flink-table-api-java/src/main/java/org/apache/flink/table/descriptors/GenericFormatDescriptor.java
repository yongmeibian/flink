 ...
 */
@Internal
public class GenericFormatDescriptor extends FormatDescriptor {

	private final DescriptorProperties properties;

	public static GenericFormatDescriptor genericFormat(String type) {
		return new GenericFormatDescriptor(type, 1);
	}

	/**
	 * Constructs a {@link GenericFormatDescriptor}.
	 *
	 * @param type String that identifies this format.
	 * @param version Property version for backwards compatibility.
	 */
	private GenericFormatDescriptor(String type, int version) {
		super(type, version);
	 ...
	 */
	public GenericFormatDescriptor property(String key, String value) {
	 ...
	 */
	public GenericFormatDescriptor properties(Map<String, String> properties) {
