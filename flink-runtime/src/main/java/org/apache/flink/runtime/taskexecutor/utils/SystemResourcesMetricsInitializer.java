...
public class SystemResourcesMetricsInitializer {
	...
	public static void instantiateSystemMetrics(MetricGroup metricGroup, Time logInterval) {
		try {
			MetricGroup system = metricGroup.addGroup("System");

			SystemResourcesCounter systemResourcesCounter = new SystemResourcesCounter(logInterval);
