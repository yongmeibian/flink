...
public class NFA<T> implements Serializable {
	 ...
	 */
	@Deprecated
	private NonDuplicatingTypeSerializer<T> nonDuplicatingTypeSerializer;
	 ...
	 * method.
	 */
	private /*transient*/ final long windowTime;
	 ...
	 */
	private /*transient*/ final boolean handleTimeout;
