...
tableEnvironment
  ...
  .withSchema(...)
  .inAppendMode()
  .registerTemporaryTable("MyTable")
{% endhighlight %}
</div>
...
tEnv.connect(new FileSystem("/source/path1"))
    ...
    .withSchema(schema)
    .registerTemporaryTable("MySource1");
tEnv.connect(new FileSystem("/source/path2"))
    .withFormat(new Csv().deriveSchema())
    .withSchema(schema)
    .registerTemporaryTable("MySource2");
tEnv.connect(new FileSystem("/sink/path1"))
    .withFormat(new Csv().deriveSchema())
    .withSchema(schema)
    .registerTemporaryTable("MySink1");
tEnv.connect(new FileSystem("/sink/path2"))
    .withFormat(new Csv().deriveSchema())
    .withSchema(schema)
    .registerTemporaryTable("MySink2");
